...
def convert_to_fsh(processed_xlsforms):
    ...
    with tqdm(total=len(processed_xlsforms), desc="Converting to FSH", dynamic_ncols=True) as pbar:
            for file_name, df_survey, df_choices, short_name, short_id, version, title in processed_xlsforms:
                ...
                questionnaire_fsh_lines = create_fsh_questionnaire(df_survey, short_name, short_id, version, title)            
                questionnaire_terminology_fsh_lines = create_fsh_questionnaire_terminology(df_choices, short_name, short_id, version, title)
                question_reference_codesystem_fsh_lines, code_tuple = create_fsh_question_reference_codesystem(df_survey, short_name, short_id, version, title)
...
def create_fsh_questionnaire(df_survey: pd.DataFrame, short_name: str, short_id: str, version: str, title: str) -> list:   
...
def create_fsh_questionnaire_terminology(df_choices: pd.DataFrame, short_name: str, short_id: str, version: str, title: str) -> list: 
    lines = []
